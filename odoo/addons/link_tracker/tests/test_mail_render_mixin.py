...
This is another: <a href="{self.base_url}/shaka?debug=1&more=2">{self.base_url}</a><br/>
...
And a 6th: <a href="/shaka">Here2</a><br>
And a 7th: <a href="{self.base_url}/shaka">Here2</a><br>
...
This is another: {self.base_url}/shaka?debug=1&more=2
