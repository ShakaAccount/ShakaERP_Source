...
class TestPortalFlow(MailCommon, HttpCase):
    ...
    def setUpClass(cls):
        ...
        cls.internal_backend_local_url = f'/shaka/{cls.record_internal._name}/{cls.record_internal.id}'
        cls.portal_backend_local_url = f'/shaka/{cls.record_portal._name}/{cls.record_portal.id}'
        cls.read_backend_local_url = f'/shaka/{cls.record_read._name}/{cls.record_read.id}'
        cls.public_act_url_backend_local_url = f'/shaka/{cls.record_public_act_url._name}/{cls.record_public_act_url.id}'
        cls.discuss_local_url = '/shaka/action-mail.action_discuss'
