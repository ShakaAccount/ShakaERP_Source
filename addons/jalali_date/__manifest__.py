...
=======================
Patches the web client's date/datetime fields, date picker, search panel
and calendar view to display and enter dates in the Jalali (Persian)
calendar, switchable per user from the user preferences.
""",
    'author': 'ShakaERP',
    'maintainer': 'ShakaERP',
